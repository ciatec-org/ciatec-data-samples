...
if st.session_state.stage == 1:
    ...
    st.write("""
    Bem-vindo, Pesquisador! Para atender aos princípios **FAIR** (Findable, Accessible, Interoperable, Reusable), 
    devemos mapear o projeto **CIATec** usando ontologias e vocabulários ontológicos consolidados e abertos.
    """)
    ...
    with col2:
        ...
        sensores cinemáticos (MediaPipe/Inerciais) e eventos dos jogos sérios (ex: Basquete Virtual)[cite: 1, 2, 5].
        """)
...
# -----------------------------------------------------------------------------
    ...
    Selecione quais classes e propriedades devem ser mapeadas na ontologia:
    """)
...
# -----------------------------------------------------------------------------
    ...
    st.write("""
    Para atualizar o **Digital Twin** em tempo real e realimentar os algoritmos adaptativos do jogo, 
    ...
    rag_option = st.radio(
        "Como o LLM utilizará a Ontologia?",
...
# -----------------------------------------------------------------------------
# FASE 4: RESULTADO - GERAÇÃO DA ONTOLOGIA RDF/TURTLE E PROMPT PARA LLM
# -----------------------------------------------------------------------------
    ...
    with tab1:
        ...
        g.add((CIATEC.Participant, RDFS.label, Literal("Participante do Projeto CIATec", lang="pt")))
        ...
        g.add((CIATEC.DigitalTwinState, RDFS.label, Literal("Vetor de Estado do Gêmeo Digital", lang="pt")))
        ...
        # Exemplo de Instância (Amostra FAIR)
    ...
    with tab2:
        ...
        st.write("""
        Para evitar alucinações em avaliações funcionais e relatórios pedagógicos, 
        o LLM deve ser instruído a responder **estritamente ancorado (*grounded*)** nas triplas do Grafo de Conhecimento[cite: 1]:
        """)
